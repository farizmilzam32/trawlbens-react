    ...
    <div className="bg-gray">
      <div className="text-center wrapper">
        ...
        <div className="md:flex justify-center mt-5">
          <button className="bg-hijau text-putih py-2 px-4 rounded-full mb-4 mr-2 text-lg font-bold">
          ...
          <button className="bg-putih text-black py-2 px-4 rounded-full mb-4 mr-2 text-lg font-bold ">
            <div className="flex gap-2">
              <svg
